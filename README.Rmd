...
Functions are currently being written to load other data that has been pulled from the NBC Olympics API. Both pre-parsed CSVs will be availible as well as the raw JSON files.
