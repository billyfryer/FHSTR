...
This package currently provides data from the 2022 Beijing Olympics from NBC's API. The name of this package comes from the Olympic Motto: "Faster, Higher, Stronger - Together".
...
Due to the nature of their tournaments, Hockey and Curling Function different from the rest of the sports. An example workflow for Hockey and Curling is shown below:

```{r workflowhockey, eval = FALSE}
# Call the Package
library(FHSTR)
...
The following code can be applied to the rest of the sports. Bobsled was selected as an example.

```{r workflowother, eval = FALSE}
# Call the Package
library(FHSTR)
...
**If you want to see a project that uses the FHSTR package, check out the [Biathlon Mass Start Clustering Project](https://billyfryer.com/projects/beijing-2022-biathlon-mass-start-clustering/) that I did!**

## Raw Datasets

If you want to use the CSV or JSON data sets outside of R, they are available at the at this link: [Beijing 2022 Data Repository](https://github.com/billyfryer/Beijing-Olympics-Data-Repo/tree/main/Data)