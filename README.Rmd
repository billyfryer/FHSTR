...
So far there are 3 pre-loaded data sets in the FHSTR package to help get you started. To learn more about these data sets, uncomment and try the code chunk below!
...
Functions are currently being written to load other data that has been pulled from the NBC Olympics API. Both pre-parsed CSVs will be available as well as the raw JSON files.
